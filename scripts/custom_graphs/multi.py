...
from rovpp_pkg.__main__ import V1Multi1
from rovpp_pkg.__main__ import V1Multi10
from rovpp_pkg.__main__ import V1Multi100
...
class CtrlVsDataGraph:
    ...
    def _generate_graph(self, metric_key: MetricKey, _relevant_rows, outcome) -> None:
        ...
        if not relevant_rows:
            return
        graph_name = f"multi_{outcome.name}.png"
        ...
        for key, graph_rows in as_cls_rows_dict.items():
            ...
            print([x["value"] for x in graph_rows_sorted])
            input()
        # Set labels
...
pickle_path = Path("~/Desktop/graphs/subprefix_multi_atk/data.pickle").expanduser()
