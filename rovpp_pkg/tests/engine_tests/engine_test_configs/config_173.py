...
config_173 = EngineTestConfig(
    ...
    scenario_config=ScenarioConfig(
        ...
        override_non_default_asn_cls_dict=frozendict({5: ROVPPV2SimpleAS, 8: ROVPPV2SimpleAS, 10: ROVPPV2SimpleAS, 15: ROVPPV2SimpleAS, ASNs.VICTIM.value: ROVPPV2SimpleAS})
    ),
    graph=graph_036,
