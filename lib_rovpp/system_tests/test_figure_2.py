...
class Test_Figure_2(Graph_Tester):
    ...
    def test_figure_2b_v1(self):
        ...
        victim = 99
       	...
       	exr_output = {[11, 44, 12, 88, 86, 99, 666, 77, 78]
                      44: HijackLocalRib(prefix_vic_as_path=(44, ASNs.VICTIM.value),
                                         subprefix_as_path=(44, ASNs.ATTACKER.value)),
                      {"asn": 77,
                       "prefix": Attack.default_subprefix,
    ...
    def test_figure_2b_rovpp(self, adopt_pol):
        r"""v1 example with ROV++v1 Lite instead of ROV++v1
        ...
        traceback_dict = {
                    ...
                    77: Conds.BHOLED,
                    44: Conds.HIJACKED,
                    78: Conds.NOTHIJACKED,
                    12: Conds.NOTHIJACKED,
                    88: Conds.NOTHIJACKED,
                    86: Conds.NOTHIJACKED,
